...
describe('Password', () => {
  ...
  describe('create', () => {
    ...
    it('throw "Invalid credentials" if email does not exist', () => {
  ...
  describe('update', () => {
    ...
    it('throw an error if password and confirmPassword are different', () => {
    ...
    it('throw error if reset token has expired', () => {
